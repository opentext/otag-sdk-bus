...
public class SDKCallInfo {
     ...
     */
    private Map<String, Object> reponseHeaders;
    ...
    public SDKCallInfo(String requestUrl, Map<String, Object> requestHeaders, int responseStatus,
                       Map<String, Object> responseHeaders, String responseBody) {
    ...
    public Map<String, Object> getReponseHeaders() {
        return reponseHeaders;
    }

    public void setReponseHeaders(Map<String, Object> reponseHeaders) {
